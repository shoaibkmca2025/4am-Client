      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full glass border border-zinc-200 dark:border-white/5 shadow-premium backdrop-blur-md">
              <span className="w-2 h-2 rounded-full bg-brand-primary animate-pulse shadow-[0_0_10px_#2563EB]" />
          ...
          {/* Desktop HUD Sidepanel - Perfectly Aligned */}
          <div className="hidden lg:block lg:col-span-4 pl-8">
            ...
            >
              {[
                ...
                { icon: Signal, label: 'Throughput', value: '1.2ms_Latency', color: 'text-brand-signal' },
                { icon: Zap, label: 'Optimization', value: 'Tier_1_ROI', color: 'text-brand-accent' }
              ].map((item, i) => (
